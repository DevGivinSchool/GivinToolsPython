...
def verification_for_school_friends(text):
    ...
    if 'Клуб пробуждения Друзья (2 уровень)' in text:
        return 2
    elif r"""Клуб пробуждение "Друзья" (1 000 руб.)""" in text:
        return 1
    elif r"""Клуб пробуждения "Друзья" 1 уровень (ежемесячная подписка) (1 000 руб.)""" in text:
        return 1
    elif r"""Клуб пробуждения Друзья (1 уровень) (со скидкой)""" in text:
        return 1
    elif r"""Клуб пробуждения Друзья (2 уровень) (со скидкой)""" in text:
        return 1
    elif 'Клуб пробуждения Друзья (1 уровень) (Первый месяц бесплатно)' in text:
        return 1
    elif r'Клуб пробуждения Друзья 1 уровень (ежемесячная подписка)' in text:
        return 1
    else:
