    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fio', models.CharField(blank=True, db_index=True, max_length=500, null=True, verbose_name='Фамилия и Имя по русски')),
                ...
                ('payment_date', models.DateField(blank=True, default=datetime.date.today, null=True, verbose_name='Дата оплаты')),
                ...
                ('type', models.CharField(choices=[('N', 'новый участник (первый месяц)'), ('P', 'регулярный участник'), ('B', 'заблокированный'), ('E', 'наш сотрудник'), ('V', 'VIP (особые условия, например, участие без оплаты)')], default='N', max_length=1, verbose_name='Тип участника: N - новый участник (первый месяц); P - регулярный участник; B - заблокированный; E - наш сотрудник; V - VIP (особые условия, например, участие без оплаты)')),
                ...
                ('fio_eng', models.CharField(blank=True, db_index=True, max_length=500, null=True, verbose_name='Фамилия и Имя по английски')),
