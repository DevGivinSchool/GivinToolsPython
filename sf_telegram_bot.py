# TODO: Участник может раньше прислать сообщение в телеграм для бота когда его еще нет в БД. Нужно его запоминать в отложенные и позже обрабатывать
# можно из текущих сообщений выдергивать только @username потом складывать этот список со списком отложенных и потом уже по общему списку идти с проверкой по БД.

# TODO: Нужно ссылку на бота вставить в одностраничники и разослать по чатам и по почтам.

# TODO: Добавить все оповещения в Telegram, блокировка и т.п.
